...
<div data-search-controller-url="{$search_controller_url}">    
  <form style="display: flex;" method="get" action="{$search_controller_url}">
      <input type="hidden" name="controller" value="search">
      <div class="sp-search-input">
          <input style="text-indent: 8px;" type="text" name="s" value="{$search_string}" placeholder="{l s='Search our catalog' d='Shop.Theme.Catalog'}" aria-label="{l s='Search' d='Shop.Theme.Catalog'}">
      </div>
